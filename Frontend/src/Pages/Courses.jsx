...
import { FaArrowLeft, FaSearch, FaBell, FaHome, FaGraduationCap, FaSitemap, FaUsers, FaPaw } from "react-icons/fa";
import "./Courses.css";
...
const Courses = () => {
  ...
  return (
    <div className="courses-container">
      ...
      {/* Course Grid */}
      <div onClick={()=>{navigate("/courseModule")}} className="courses-grid">
        {courses.map((course, index) => (
          <div key={index} className="course-card">
            <img src={course.image} alt={course.name} className="course-image" />
            <p className="course-name">{course.name}</p>
            {course.progress && <span className="progress">{course.progress}</span>}
          </div>
        ))}
      </div>
